	...
	<div class="clearfix">
		<div class="layout">
			...
			<div class="col-main">
				...
				<div class="main-3">
					<div class="title-box">
						<h4 class="orange-t">Các đơn hàng vừa đặt</h4>
						<a class="" href="order-history.php">Xem tất cả</a>
					</div>
					<table class="table table-striped table-bordered" id="my-orders-table">
						...
						<tbody>
                            <tr class="first last odd">
								<td><a href="order-detail.php" title="Xem đơn hàng">100198318</a></td>
								<td>05/02/2013 </td>
								<td>ĐẶNG  LINH&nbsp;</td>
								<td><span class="price">182.000,00&nbsp;₫</span>&nbsp;</td> 
								<td>
									<a href="order-detail.php" title="Xem đơn hàng">
										<em>Hoàn thành</em>&nbsp;
									</a>
								</td>
								<td class="last">
