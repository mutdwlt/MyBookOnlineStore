    	...
    	<!----- START CONTENT --------->
          ...
          <div class="middle_content">
			<div class="title" id="no_border">
                	<p class="font_title">Sách sắp có mặt trên HEDSPI Bookstore</p>
			</div>
			<div class="divider xam">
				...
				<?php
					...
					$sql="SELECT * FROM books WHERE DATEDIFF(publish_date,CURDATE())>0 ORDER BY publish_date LIMIT 0,15";
